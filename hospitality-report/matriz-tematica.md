# Matriz Temática — Hospitality Report

Documento vivo donde se registra cada artículo/fuente, clasificado según el índice
del reporte (ver `plantilla-indice.md`). Se actualiza incrementalmente a medida
que se comparten enlaces. Traído de Google Drive como punto de partida el
2026-09-17.

**Cómo se usa:** cada fila = un artículo. "Dato/idea clave" va parafraseado (no
cita textual salvo casos puntuales de ≤15 palabras). El objetivo es poder filtrar
por sección y detectar patrones, consensos o contradicciones antes de redactar
cada capítulo.
...
| Fuente | Fecha | Subtema | Dato/idea clave |
|---|---|---|---|
| EHL, "Hospitality Outlook Report 2026" | 27 nov 2025 | Tamaño y peso del sector — cifras macro | El mercado global de hostelería pasó de 4,67 a 4,9 billones de dólares en 2024, con proyección de crecimiento anual del 5,3% hasta ~7 billones en 2029. Viajes y turismo aportan 11,7 billones de dólares a la economía global (10,3% del PIB mundial) y emplean a ~371 millones de personas; en la próxima década se estima que 1 de cada 8 empleos del planeta (460 millones) estará ligado al sector. |
...
| McKinsey & Company, "State of Food & Beverage: The choices CPG leaders can make to renew growth" (leído completo, PDF aportado por Andrea, sin bloqueo de red — fuente de máxima fiabilidad de esta matriz) | abr 2026 (encuesta global propia a 15.169 consumidores en 10 mercados, 28 nov-12 dic 2025) | El modelo de crecimiento del gran consumo ha tocado techo | El TSR (retorno total al accionista) de las mayores CPG de alimentación y bebida ha caído ~7% desde 2023, mientras el S&P 500 crecía ~9% en el mismo periodo; el crecimiento de volumen del sector se ha quedado por debajo del 1% anual, muy lejos de lo que entregaba antes (9% de crecimiento de ingresos en 2002-2012, ahora prácticamente plano). **Nota de encaje:** esto es gran consumo envasado (supermercado), no hostelería estricta, pero la tesis de fondo —un modelo de crecimiento que dejó de funcionar porque el consumidor cambió más rápido que la propuesta de valor— es directamente transferible, y varios datos de consumo de este mismo informe sí son 100% de hostelería (ver Shifts y Food & Drink). |

## 03. THE SHIFTS

| Fuente | Fecha | Subtema | Dato/idea clave |
|---|---|---|---|
| Mintel, "2026 Global Consumer Predictions" | 2026 | Automatización visible — reacción mixta | La Quinta Inn & Suites (Florida) se hizo viral por un check-in 100% por tablet sin personal físico — la automatización del front desk ya es visible y genera conversación pública. |
| Mintel, "2026 Global Consumer Predictions" | 2026 | Ocio como antídoto a la soledad, vía marca | Heineken lanzó "Bar Dating", app de swipe para descubrir bares y reactivar vida social — una marca de bebidas posicionándose como solución al aislamiento social. |
| McKinsey, "State of Food & Beverage" | abr 2026 | La restauración le sigue ganando terreno al supermercado | En EEUU, el gasto en "comida fuera de casa" (restaurantes, take-away, delivery) pasó de ~48% del gasto total en alimentación a finales de los 90, a ~55% pre-pandemia, a un estimado 58% en 2025 — el retail de alimentación (supermercado) ha perdido ~10 puntos porcentuales de "cuota de estómago" en 25+ años. Dato de fondo directamente a favor del sector de hostelería frente al de gran consumo envasado, incluso con la presión de precios que sufre el consumidor. |
| McKinsey, "State of Food & Beverage" | abr 2026 | Contrapeso: también crece cocinar desde cero | A la vez que crece el gasto fuera de casa, los consumidores preparan de media la mitad de sus comidas desde cero en casa, con los Millennials como generación que más ha aumentado esta práctica en los últimos 2 años (aunque los Baby Boomers siguen cocinando desde cero con más frecuencia en términos absolutos: 63% de sus comidas frente a 40% en Gen Z). No es necesariamente contradictorio con el dato anterior — probablemente son ocasiones de consumo distintas dentro de la misma semana, no dos consumidores enfrentados. |
...
| Fuente | Fecha | Subtema | Dato/idea clave |
|---|---|---|---|
| Mintel, "2026 Global Consumer Predictions" | 2026 | Anti-algoritmo | Rechazo a la influencia algorítmica, se pide más control sobre experiencias digitales. Riesgo para motores de recomendación/fidelización si se sienten manipuladores en vez de útiles. |
| Mintel, "2026 Global Consumer Predictions" | 2026 | El nuevo "joven" | Las etapas vitales se difuminan: la "mediana edad extendida" prioriza experiencias sobre ahorro ("micro-retiro"). No segmentar marketing solo por edad. |
...
| WGSN, "Key Trend 2026/27: Gen Z Food & Drink Priorities" (cita como fuente original a **NielsenIQ, "Spend Z", 2024**) | ed. 2026/27 (fecha exacta no especificada) | Peso económico de la Gen Z | Gen Z (nacidos 1997-2012) representa una cuarta parte de la población mundial y su poder de gasto global se proyecta en 12 billones de dólares (trillion USD) para 2030 — segmento de consumo cada vez más determinante para F&B. |
| WGSN, "Key Trend 2026/27: Gen Z Food & Drink Priorities" (cita como fuente original a **Datassential, "2025 Trends Preview Report", 2024**) | ed. 2026/27 | Gen Z como motor de tendencias — comparativa generacional (dato refinado) | En EEUU, 71% de la Gen Z está entusiasmada con nuevas tendencias de comida y bebida en 2025, frente a solo 59% de los Boomers — la brecha generacional de apertura a lo nuevo es el dato relevante, no solo el entusiasmo de la Gen Z en sí. |
| WGSN, "Key Trend 2026/27: Gen Z Food & Drink Priorities" (cita como fuente original a **Statista, 2024**) | ed. 2026/27 | Gen Z como motor de tendencias — desglose de plataformas (dato refinado) | En EEUU/Reino Unido, la Gen Z usa TikTok (70%), Instagram (65%) y YouTube (41%) como fuentes de recomendación alimentaria — confirma que la plataforma social, no la crítica especializada, marca el descubrimiento, y que no es solo TikTok: son varias redes a la vez. |
| WGSN, "Key Trend 2026/27: Gen Z Food & Drink Priorities" | ed. 2026/27 | Metodología — alineación con Big Ideas de WGSN | Este pronóstico se alinea explícitamente con dos "Big Ideas" del STEPIC de WGSN: **Feel Appeal** y **Play Power** — útil para citar la metodología si se referencia este informe en el reporte final. |
...
| McKinsey, "State of Food & Beverage" | abr 2026 | La salud es el factor de decisión que más rápido crece | 57% de los consumidores globales sitúa la salud entre sus 3 factores de decisión al comprar comida — el mayor incremento de importancia de cualquier atributo en los últimos 2 años (aunque sabor, precio y calidad siguen siendo, en conjunto, más priorizados). ~75% busca activamente fruta/verdura fresca, ~60% busca proteína/fibra/nutrientes, la mitad evita activamente azúcar, alcohol o ultraprocesados. |
| McKinsey, "State of Food & Beverage" | abr 2026 | El "gap entre decir y hacer" en salud | La intención de comer sano no siempre se traduce en compra real — por presupuesto, disponibilidad, sesgo hacia la conveniencia, falta de transparencia de producto o simple hábito. Matiz importante para no asumir que "más interés en salud" se traduce automáticamente en más ventas de producto saludable — el consumidor aspira a comer mejor, pero de forma selectiva e inconsistente. |
| McKinsey, "State of Food & Beverage" | abr 2026 | El GLP-1 ya cambia la cesta de la compra | 6 meses después de adoptar GLP-1 (fármacos tipo Ozempic), el gasto medio cae en snacks salados (-11,5%), bollería dulce (-8,5%), refrescos (-6,8%) y galletas (-7,0%), mientras sube en fruta/verdura fresca (+1,5%), yogur (+2,5%) y snacks de carne (+1,0%). El mercado global anti-obesidad podría crecer 15% anual hasta 130.000 millones de dólares en 2034 (IQVIA, citado por McKinsey). Primera vez que un fármaco parece cambiar de forma medible qué compra la gente — relevante para cualquier negocio de F&B que dependa de snacking/indulgencia como categoría central. |
| McKinsey, "State of Food & Beverage" | abr 2026 | El precio ya es la primera causa de abandono de marca | 61% dice que el precio le importa más que hace 2 años; coste y percepción de valor son la primera razón para dejar de comprar una marca (por delante de calidad, variedad y falta de novedad). Más de 8 de cada 10 consumidores en EEUU que notan "shrinkflation" (reducir tamaño o calidad manteniendo el precio) dicen que se siente engañoso, y 2 de cada 3 dejaron de comprar ese producto por ello — efecto especialmente marcado en Gen Z. |

## 06. FOOD & DRINK

| Fuente | Fecha | Subtema | Dato/idea clave |
|---|---|---|---|
| Gluttonomy, "Food & Beverage Trends 2026" | 2026 | Vuelta a la hamburguesa gruesa | Tras años de smash burger, el péndulo vuelve a la hamburguesa gruesa y jugosa. Según Tastewise, el interés por proteína crece 3x más rápido en carne que en sustitutos vegetales. |
| Gluttonomy, "Food & Beverage Trends 2026" | 2026 | Regreso del steakhouse | El steakhouse "reimaginado" vuelve tras una década de omakase: menos estirado, cócteles clásicos, hospitalidad marcada. Ligado a bienestar metabólico (proteína, GLP-1) y nostalgia. |
| Gluttonomy, "Food & Beverage Trends 2026" | 2026 | La textura como nuevo sabor | La textura se convierte en motor de deseo, potenciada por redes (TikTok premia alimentos que "suenan" al morderlos). |
| Gluttonomy, "Food & Beverage Trends 2026" | 2026 | Panaderías de diáspora | Panaderías japonesas, coreanas, venezolanas, mexicanas, de Oriente Medio se convierten en el nuevo "tercer espacio" social diurno. |
| Gluttonomy, "Food & Beverage Trends 2026" | 2026 | La fibra como nuevo macronutriente estrella | Tras la obsesión por proteína, el foco pasa a fibra (saciedad, digestión, glucemia), impulsado por la cultura GLP-1. |
...
| Fuente | Fecha | Subtema | Dato/idea clave |
|---|---|---|---|
| Deloitte, "How AI is revolutionizing restaurants" | jun 2025 (encuesta Q4 2024, 375 ejecutivos, 11 países) | Adopción de IA — inversión | La gran mayoría prevé aumentar inversión en IA el próximo ejercicio; casi ninguno espera reducirla. |
| Deloitte, "How AI is revolutionizing restaurants" | jun 2025 | Adopción de IA — por oleadas | 1ª ola consolidada (cliente/inventario); 2ª ola en fidelización/empleado (~70%); 3ª ola incipiente en preparación de alimentos (<50%). |
| Deloitte, "How AI is revolutionizing restaurants" | jun 2025 | Tecnologías concretas | Chatbots lideran uso diario, luego machine learning. IA generativa, avatares y mundos virtuales: más planificación que uso real. |
| Deloitte, "How AI is revolutionizing restaurants" | jun 2025 | Brecha de preparación | Solo ~20% se siente listo en gobernanza/riesgo de IA; <30% en infraestructura y talento. Solo en estrategia la mayoría se siente cómoda. |
| Deloitte, "How AI is revolutionizing restaurants" | jun 2025 | Diferencias regionales | Asia lidera adopción y preparación frente a EEUU/Europa. Casual dining es el segmento más agresivo adoptando IA. |
| Deloitte, "How AI is revolutionizing restaurants" | jun 2025 | Principales frenos | El freno no es compromiso directivo ni tecnología disponible: es identificar casos de uso correctos, falta de talento técnico y ausencia de gobernanza — freno organizativo, no tecnológico. |
...
| McKinsey, "State of Food & Beverage" | abr 2026 | La marca grande pierde por dos flancos a la vez | Motivo declarado para comprar una marca grande: calidad (64%, pero la diferencia con marca blanca es de solo -33 puntos y con marca pequeña de 0 — la calidad ya es "table stakes", no un diferenciador real). La marca blanca gana en precio (+34 puntos de diferencia a su favor) y las marcas pequeñas ganan en funcionalidad (+19 puntos) — las marcas grandes se quedan sin ventaja clara en ningún eje. Marcas pequeñas independientes (menos de 100M$ en ventas) eran el 13% del mercado de F&B en EEUU en 2021 pero generaron el 35% del crecimiento de categoría en 2023-2025 (la marca blanca, aún más: 48% del crecimiento del periodo). Mismo patrón que el caso Papa John's de esta sección, ahora con marco de sector completo detrás. |
| McKinsey, "State of Food & Beverage" | abr 2026 | Nueva disciplina: optimizar para que la IA te recomiende | 31% de los consumidores en EEUU que usan IA generativa ya la usan para comprar alimentación (McKinsey ConsumerWise), más aún en Millennials y Gen Z. Aparece una disciplina nueva, **"generative engine optimization" (GEO)**: contenido claro y fiable, alto engagement social, reseñas gestionadas activamente, descripciones de producto consistentes entre webs — el equivalente al SEO, pero para que te recomiende un modelo de IA en vez de posicionarte en Google. **Conecta directamente** con el dato ya registrado de DoorDash+SevenRooms en esta misma sección (22% ya usa IA para descubrir restaurante): GEO es el "cómo" que le faltaba a ese "qué". |
| McKinsey, "State of Food & Beverage" | abr 2026 | Cuánto puede ahorrar la IA en la cuenta de resultados | La próxima ola de IA podría liberar entre 200 y 300 puntos básicos adicionales de reducción de costes en toda la cuenta de resultados (marketing, revenue management, compras, finanzas, cadena de suministro) — cifra concreta que faltaba en el resto de fuentes de IA ya citadas en esta matriz (Deloitte, EHL), que hablan de adopción pero no de cuánto ahorro estructural es realista esperar. |
...
| Nombre/concepto | Ubicación | Por qué destaca | Fuente |
|---|---|---|---|
| Cup of Joy | Marylebone, Londres (origen Estambul) | Primer paso internacional de una cadena de café turca de nicho; interiorismo site-specific en vez de formato replicable estándar. | Wallpaper*, ago 2026 |
| Camp No Counselors | EEUU | Retiro de fin de semana todo incluido solo para adultos — respuesta directa al "déficit de afecto"/soledad adulta. | Mintel, 2026 Global Consumer Predictions |
| Burn Lab (Sandwell Leisure Trust) | Reino Unido | Gimnasio pensado para creadores de contenido — cruce fitness/hostelería/economía de creadores. | Mintel, 2026 Global Consumer Predictions |
...
| Guinness — "Splitting the G" | Reino Unido / global | Marca de 267 años que más que dobló su viralidad social (2023-2024) apoyándose en un ritual de bar ya existente entre sus clientes (partir la pinta justo por la letra G de la etiqueta al beber) y amplificado por "Guinfluencers" en redes — ejemplo directo de cómo una marca de bar rejuvenece sin cambiar el producto, activando un ritual que ya existía en vez de inventar uno de cero. | McKinsey, "State of Food & Beverage", abr 2026 |
| Barebells / Built (barritas proteicas "golosina") | EEUU / Europa | Snacks proteicos que se posicionan como golosina, no como suplemento — 15-20g de proteína, poco o nada de azúcar añadido, con un precio premium claro (pack de 12 de Barebells ~30$ frente a 15-20$ de barritas o caramelos tradicionales) y aun así entre las marcas de F&B independientes de más rápido crecimiento en EEUU y Europa. Caso de manual de "saludable con disfrute", coherente con los patrones ya documentados de Flax & Kale/Honest Greens/CAVA en la Fase A de The Local. | McKinsey, "State of Food & Beverage", abr 2026 |
| Xeque Mate (bebida lista para beber, con y sin alcohol) | Brasil | Marca pequeña que ganó penetración anclándose a momentos de alta energía social (Carnaval, festivales callejeros) en vez de depender de medios pagados — ejemplo de "tácticas de disruptor" (muestreo, marketing de calle, rituales culturales) frente al playbook de marketing tradicional. | McKinsey, "State of Food & Beverage", abr 2026 |

## 10. EARLY SIGNAL

| Señal | Dónde se detectó | Por qué podría escalar | Fuente |
|---|---|---|---|
| IA generativa, avatares y "mundos virtuales" en restauración | Encuesta global Deloitte | Adopción diaria marginal, pero mayor plan de desarrollo futuro. | Deloitte, jun 2025 |
...
Espacio para la conclusión/visión de cierre, se redacta al final con la síntesis
de todo lo anterior.

**Nota de dirección (candidata fuerte a hilo de cierre):** el cierre de Gluttonomy
resume que la comida en 2026 se vuelve más intencional, sensorial y humana — ya no
se busca el próximo gimmick, sino algo real y alineado con cómo se quiere vivir.
Viniendo de una fuente centrada solo en F&B, converge con la misma tesis
transversal de Deloitte (la tecnología sola no basta) y Mintel (déficit de
afecto, fatiga del algoritmo). Tres informes de ángulos distintos —
operaciones/IA, comportamiento del consumidor, gastronomía — convergiendo en la
misma idea. Mejor candidato hasta ahora para el texto de cierre.

---

## Backlog de síntesis (cross-tema)

Ideas y conexiones entre secciones que no encajan en una sola tabla — aquí salen
los "insights nuevos" del reporte que son refuerzos mutuos, no contradicciones.

- **Gap ambición vs. gobernanza:** el entusiasmo inversor en IA (~100% aumentando
  presupuesto) contrasta con la falta de preparación en riesgo/gobernanza (~20%
  listo). Candidata para **08. ONE QUESTION**: *¿estamos invirtiendo en IA más
  rápido de lo que somos capaces de gobernarla?*
- **El freno no es tecnológico, es humano/organizativo:** según Deloitte, lo que
  menos preocupa es la tecnología en sí; lo que más, identificar el caso de uso
  correcto y el talento. Posible narrativa transversal si otros artículos
  confirman que la barrera real es de talento/cultura, no de acceso a
  herramientas.
- **Divergencia regional (Asia vs. Occidente):** Asia lidera adopción y
  preparación. Vigilar si otros artículos confirman este patrón como hilo
  conductor entre varias secciones.
- **El steakhouse como prueba de campo del "déficit de afecto":** Gluttonomy
  describe el regreso del steakhouse como reacción al minimalismo (omakase) hacia
  salas ruidosas y cálidas. Encaja con la tesis de Mintel — el comensal busca
  calidez humana explícita como parte del producto.
- **Panaderías de diáspora como "tercer espacio":** otro punto de apoyo de la
  misma tesis — conexión humana informal, food & beverage respondiendo en
  distintos formatos (steakhouse de noche, panadería de mañana).
- **Tesis central del reporte, con tres fuentes independientes de respaldo**
  (candidata firme para **02. THE BIG PICTURE** y **11. CLOSING**): la hostelería
  de 2026 vive una tensión entre eficiencia/automatización y demanda creciente de
  humanidad/conexión real. Ganar en 2026 no es elegir un bando, sino saber en qué
  momento del recorrido del cliente toca cada uno.
- **La brecha de percepción de precio conecta con "indulgencia asequible":**
...
- **McKinsey cierra el triángulo precio-calidad-abandono de marca (nuevo):**
  el dato de McKinsey de que precio/valor percibido es la primera causa de
  abandono de marca (por delante de calidad) y el rechazo a la "shrinkflation"
  (8 de cada 10 lo sienten engañoso) dan la explicación de fondo a por qué
  funciona la "indulgencia asequible" de Gluttonomy y por qué Papa John's
  (esta misma matriz, Business of Hospitality) pierde precisamente en el eje
  de "valor" y no en el de calidad — las tres fuentes describen la misma
  dinámica de mercado desde ángulos distintos (bebidas, restauración francesa,
  gran consumo global).
- **Comer fuera crece en gasto, pero el "tercer espacio" social migra a casa —
  no es la misma tendencia (nuevo, vía McKinsey):** ojo con no confundir dos
  cosas parecidas. McKinsey documenta que el gasto en comida fuera de casa
  sigue ganando cuota frente al supermercado (48%→58% en EEUU en 25 años);
  WGSN y Mintel documentan que la vida social/el "tercer espacio" tiende a
  desplazarse a casa. No se contradicen: la gente sigue gastando más en
  comer fuera (conveniencia, comida preparada, delivery), pero cada vez más
  de ese consumo no sustituye la socialización que antes ocurría en el bar o
  restaurante — son dos ejes distintos (dónde se gasta el dinero en comida vs.
  dónde ocurre la vida social) que conviene no mezclar al escribir el reporte.
...
Ideas individuales de la matriz que, puestas una al lado de la otra, se
contradicen o tensionan. Son hipótesis a validar, no conclusiones cerradas.

### 1. Automatización vs. conexión humana (la tensión madre del reporte)

- **Idea A (Deloitte):** la restauración invierte masivamente en IA; casi 100%
  de ejecutivos prevé aumentar inversión.
- **Idea B (Mintel):** "déficit de afecto" — la gente evita interacción casual en
  favor de eficiencia; las marcas que reintroduzcan conexión humana pueden
  diferenciarse.
- **Idea C, refuerzo (EHL):** la IA debe complementar, no sustituir — la misma
  tesis dicha desde dentro de la academia de hostelería.
- **Contradicción interna en la propia Idea B:** el mismo Mintel muestra que 75%
  en Brasil quiere pedir sin interacción humana, y 56% en EEUU valora el
  autopago — el consumidor que "rechaza" la automatización es, en la práctica,
  el mismo que la pide.
- **Reflexión:** no es cuestión de bando, sino de *momento del recorrido*. El
  reto no es tomar partido, sino cartografiar en qué punto del viaje del cliente
...
- **Idea A (Mintel):** "Anti-Algoritmo" — rechazo a la influencia algorítmica,
  se pide más control.
- **Idea B (Coca-Cola):** 58% recomendaría un QSR por buena personalización de
  pedido; es uno de los 4 ejes de valor.
- **Idea C (NRA):** hidratación personalizada como una de las 5 grandes
  tendencias de bebida 2026.
- **Reflexión:** probablemente no se rechaza la personalización en sí, sino la
  sensación de que el algoritmo decide *por* el cliente en vez de darle
  herramientas para decidir *él mismo* — distinción entre personalización-como-
  control (bien recibida) y personalización-como-manipulación (mal recibida).
  Buen candidato a ángulo propio del reporte.

### 3. Raciones grandes vs. raciones pequeñas

- **Idea A (Gluttonomy):** vuelve la hamburguesa gruesa y el steakhouse con
  cortes generosos.
- **Idea B (Coca-Cola):** 54% prefiere raciones más pequeñas (salud, desperdicio,
  ahorro), especialmente en hogares con niños.
- **Reflexión:** posiblemente son ocasiones de consumo distintas (indulgencia
  puntual vs. comida cotidiana/familiar), pero falta evidencia cruzada. Candidata
  para **08. ONE QUESTION**: *¿hablamos de dos consumidores distintos o del mismo
  consumidor en dos momentos distintos de su semana?*

### 4. Alcohol — ¿caída o resurgir?

- **Idea A (NRA):** low/no-alcohol es una de las tendencias de bebida más
...
- **Idea A (Coca-Cola):** 2 de cada 3 comen menos fuera por subida de precios;
  brecha de valor percibido del 37%.
- **Idea B (NRA):** 37% pagaría más por bebidas únicas que no encuentra en otro
  sitio.
- **Idea C (Gluttonomy):** "indulgencia asequible" — el consumidor redirige el
  gasto hacia pequeños lujos percibidos como especiales.
- **Reflexión:** no es contradicción real, es la misma "brecha de valor
  percibido" vista desde ángulos distintos — el consumidor no rechaza el gasto,
  rechaza pagar de más por algo que no siente distinto o especial. Cuanto más
  único/irreplicable se perciba el producto, mayor tolerancia al precio.
